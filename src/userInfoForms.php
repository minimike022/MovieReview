                ...
                <div class="flex flex-col justify-between h-[23em]">
                    ...
                    <div class="flex justify-between w-[59em]">
                        <span>
                            ...
                            <input type="text" id="lname" name="lname" placeholder="Last Name"
                                class="border-2 border-black rounded-xl text-lg px-2 h-12 w-72">
                        </span>
                        <span>
                    ...
                    <div class="flex justify-between w-[59em]">
                        <span>
                            ...
                            <input type="text" id="address" name="address" placeholder="Address"
                                class="border-2 border-black rounded-xl text-lg px-2 h-12 w-[34em]">
                        </span>
                        <span>
                    ...
                    <div>
                        <button type="submit" id="submit" value="submit" name="submit"
                            class="border-2 rounded-xl bg-green-400 text-lg h-12 w-72 text-lg font-bold text-white border-none hover:bg-green-500 active:bg-green-600">Submit</button>
                    </div>
                </div>
            </form>
        </div>
