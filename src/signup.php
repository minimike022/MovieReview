    ...
    <div class="w-[25em] h-[30em] bg-black absolute mt-20 rounded-md bg-opacity-80">
        ...
        <form action="" method="POST" id="addUser" class="flex flex-col w-full items-center mt-6">
            <input type="text" id="uname" name="uname" placeholder="Username"
                class="focus:outline-none h-[2.8em] rounded-md bg-[#3D3C3A] w-[19em] pl-4">
            <span class="flex text-left w-full">
                <h2 id="validationTag" class="text-[#ED2939] font-bold text-sm mt-2 ml-12">Username Already Taken!</h2>
            </span>
            <input type="text" id="email" name="email" placeholder="Email"
                class="focus:outline-none h-[2.8em] rounded-md bg-[#3D3C3A] w-[19em] pl-5 mt-4">
            <input type="password" id="pword" name="pword" placeholder="Password"
                class="focus:outline-none h-[2.8em] rounded-md bg-[#3D3C3A] w-[19em] pl-5 mt-4">
            <input type="submit" name="submit" value="submit"
                class="focus:outline-none h-[2.8em] rounded-md bg-red-600 w-[19em] mt-6">
        </form>
        <div class="flex flex-col items-center mt-4">
            <a href="login.php" class="mt-8">
